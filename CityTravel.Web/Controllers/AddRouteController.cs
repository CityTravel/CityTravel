...
namespace CityTravel.Web.Controllers
{
    ...
    public class AddRouteController : BaseController
    {
        ...
        private readonly List<SelectListItem> itemsForDropDown = new List<SelectListItem>
        {
                new SelectListItem
                    {
                       Text = Resources.ShuttleTransport, Value = ((int)Transport.Bus).ToString() 
                    }, 
                new SelectListItem
                    {
                       Text = Resources.TroleyBus, Value = ((int)Transport.Trolleybus).ToString() 
                    }, 
                new SelectListItem { Text = Resources.Tramvay, Value = ((int)Transport.Tramway).ToString() }, 
                new SelectListItem { Text = Resources.Metro, Value = ((int)Transport.Subway).ToString() }
        };
