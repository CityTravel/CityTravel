...
namespace CityTravel.Web.Models
{
    ...
    public class FeedbackViewModel
    {
        ...
        [RegularExpression("^[a-z0-9_\\+-]+(\\.[a-z0-9_\\+-]+)*@[a-z0-9-]+(\\.[a-z0-9-]+)*\\.([a-z]{2,4})$", 
            ErrorMessageResourceName = "YouEnterWrongAdress", ErrorMessageResourceType = typeof(Resources))]
        [Display(Name = "ModelEmail", ResourceType = typeof(CityTravel.Translations.Resources))]
        ...
        [Display(Name = "ModelName", ResourceType = typeof(CityTravel.Translations.Resources))]
        ...
        [Display(Name = "ModelMessage", ResourceType = typeof(Resources))]
        public string Text { get; set; }

        /// <summary>
        /// Gets or sets Type.
        /// </summary>
        [Display(Name = "ChooseCategory", ResourceType = typeof(Resources))]
