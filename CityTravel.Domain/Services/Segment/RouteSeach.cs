...
namespace CityTravel.Domain.Services.Segment
{
    ...
    public class RouteSeach : IRouteSeach
    {
            ...
            IEnumerable<Transport> transportTypes)
        {
            ...
            this.AppropriateRoutes = this.DeleteIncorectRoutes(startMarker, endMarker, possibleRoutes);
            ...
            for (int i = 0; i < this.AppropriateRoutes.Count; i++)
            {
                if (!this.AppropriateRoutes[i].Type.Type.Equals("Walking"))
                {
                    ...
                    this.AppropriateRoutes[i] = this.BuildRouteProperties(this.AppropriateRoutes[i], startMarker, endMarker);
                }
            }
        ...
        private WalkingRoute GetWalkingStepsForRoute(SqlGeography startPoint, SqlGeography endPoint)
        {
