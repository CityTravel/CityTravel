[assembly: WebActivator.PreApplicationStartMethod(typeof(CityTravel.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivator.ApplicationShutdownMethodAttribute(typeof(CityTravel.Web.App_Start.NinjectWebCommon), "Stop")]

namespace CityTravel.Web.App_Start
{
    using System;
    using System.Web;
